...
module.exports = function(options) {
  ...
  return function(core) {
    ...
    db.save = function(args, callback) {
      ...
      .then(function(callback) {
        var sql = 'SELECT * FROM `'+entity.id+'` WHERE _id = ?'
        this.get('conn').query(sql, [id], callback)
      })
      .then(function(result, callback) {
        this.set('object', normalizeObjects(entity.id, result)[id])
        callback()
      })
    ...
    db.readObjects = function(args, callback) {
      ...
      txain(connect)
        .then(function(conn, callback) {
          ...
          var sql = 'SELECT * FROM `'+entity.id+'` WHERE _id IN('+placeholders+')'
        ...
        .then(function(result, callback) {
          ...
          return callback(null, normalizeObjects(entity.id, result))
        })
        .end(callback)
    }
