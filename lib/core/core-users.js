...
module.exports = function(options) {
  ...
  return function(core) {
    ...
    users.verifyCode = function(args, callback) {
      ...
      txain(function(callback) {
        var params = [code]
        core.db.query('SELECT * FROM '+core.db.quote('user')+' where __login_email_verification=?', params, callback)
      })
      ...
      .then(function(callback) {
        ...
        var query = 'UPDATE '+core.db.quote('user')+' SET __login_email_verification=?, __login_email_pending=?, __login_email_current=?'
    ...
    users.lostPassword = function(args, callback) {
      ...
      .then(function(code, callback) {
        ...
        core.db.query('UPDATE '+core.db.quote('user')+' SET __login_password_lost_code=?, __login_password_lost_date=? WHERE __login_email_current=?',
          params, callback)
      })
    ...
    users.setPassword = function(args, callback) {
      ...
      txain(function(callback) {
        var params = [code]
        core.db.query('SELECT _id FROM '+core.db.quote('user')+' WHERE __login_password_lost_code=?',
          params, callback)
      })
      .then(function(rows, callback) {
        var tx = this
      ...
      .then(function(hash, callback) {
        ...
        core.db.query('UPDATE '+core.db.quote('user')+' SET password=?, __login_password_lost_code=?, __login_password_lost_date=? WHERE __login_password_lost_code=?',
          params, callback)
      })
      .then(function(info, callback) {
        errors
